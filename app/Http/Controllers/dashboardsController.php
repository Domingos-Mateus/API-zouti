...
class dashboardsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('dashboard/dashboard', compact(
            ...
            'porcentagem_cartao_inteiro',
            'vendas_boletos',
            'porcentagem_boleto_inteiro',
            'vendas_pagas',
            'ticket_medio',
            'salesByDay',
            'transacoesPorParcela',
            'totalValorChargebacks',
            'totalQuantidadeChargebacks',
            'totalValorPreChargebacks',
            'totalQuantidadePreChargebacks',
            'preChargebacksPercentage',
            'chargebacksPercentage',
            'valoresMeses',
            'labels',
            'data'
        ))->with([
